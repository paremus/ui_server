...
@Component(service = EventSourceResource.class)
@ParemusRestUI
@JaxrsResource
@JaxrsName("Paremus Event Sources")
@Path("event_sources")
@Produces(MediaType.APPLICATION_JSON)
@RequiresAuthentication
public class EventSourceResource extends AbstractResource<IdentityDTO> {
    ...
    protected Collection<IdentityDTO> getDtos() {
        return events.getSources().stream().map(t -> mkIdentity(t)).collect(Collectors.toList());
    }
